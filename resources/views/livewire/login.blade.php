<div class="flex items-center justify-center min-h-[calc(100vh-16rem)]">
    <div class="w-80 max-w-md">
        ...
        <h2 class="text-2xl font-bold text-neutral-800 dark:text-neutral-100 mb-6 text-center">Login</h2>
        ...
        <form wire:submit.prevent="login">
            ...
            <button type="submit" class="w-full bg-red-500 hover:bg-red-600 text-white font-medium py-2 rounded-lg transition" wire:loading.attr="disabled" wire:target="login">
        ...
        <p class="text-center text-neutral-600 dark:text-neutral-400 text-sm mt-4">
            ...
            <a wire:navigate href="{{ route('register') }}" class="text-red-500 hover:text-red-700 font-medium">Register here</a>
        </p>
        </div>
    </div>
</div>