<nav class="bg-white dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100">
      <div class="container mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div class="flex items-center gap-4">
          ...
          <a href="/register" class="px-3 py-1.5 rounded-md text-xs font-semibold bg-black dark:bg-white text-white dark:text-black hover:opacity-90 transition">Register</a>
        </div>
      </div>
  </nav>
